...
score.hideturtle()
score.goto(0,260)
score.write("player1 : {}  | player2 : {} ".format(score1, score1), align = "center", font =("courrier", 15))
...
tag.hideturtle()
tag.goto(0,-270)
tag.write("Made with love By Oussama Ben Slama", align = "center", font =("courrier", 15))
...
while True :
    ...
    if ball.ycor() < -290 :
        ...
        ball.dy *= -1
    if ball.xcor() > 390 :
        winsound.PlaySound("notif.wav", winsound.SND_ASYNC | winsound.SND_ALIAS )
        ball.goto(0, 0)
        ball.dx *= -1
        score1 +=1
        score.clear()
        score.write("player1 : {}  | player2 : {} ".format(score1, score2), align = "center", font =("courrier", 15))
    if ball.xcor() < -390 :
        winsound.PlaySound("notif.wav", winsound.SND_ASYNC | winsound.SND_ALIAS )
        ball.goto(0, 0)
        ball.dx *= -1
    ...
    if score1 >= 3 :
        ...
        result.hideturtle()
        result.goto(0,0)
        result.write("Player 1 win this game , Congratulation ", align = "center", font =("courrier", 18))
        break
    ...
    if score2 >= 3 :
        ...
        result.hideturtle()
        result.goto(0,0)
        result.write("Player 2 win this game , Congratulation ", align = "center", font =("courrier", 18))
        break
